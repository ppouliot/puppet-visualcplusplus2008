...
RUN git clone https://github.com/openstack-hyper-v/windows_git windows_git
RUN git clone https://github.com/openstack-hyper-v/windows_common windows_common
